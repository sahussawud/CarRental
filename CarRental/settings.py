...
SECRET_KEY = os.environ.get('SECRET_KEY', 'django-insecure-test-key-for-development-environment-only')
...
# For testing purposes, we'll also define a separate test database configuration
